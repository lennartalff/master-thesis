...
In \cite{Mueller13} a state-to-state trajectory generation method for quadrocopters is presented. The focus is computational efficiency of the algorithms.
