...
\begin{figure}[h!]
	\centering
	\input{images/inkscape_pdf/free-body-diagram.pdf_tex}
...
\section{Control}
\begin{figure}[h!]
	\includegraphics[width=0.8\textwidth]{placeholders/inner-outer-loop}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\textwidth]{placeholders/trajectory-replanning}
...
where the feed forward terms are based on vehicle dynamics in \Cref{eq:eom-rotational-with-input}.
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{placeholders/gazebo-ros-interaction}
\end{figure}
