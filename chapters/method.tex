...
The goal of the trajectory is to bring the vehicle from an initial state $\vehiclestate_0$ to a desired final state $\vehiclestate_{\text{f}}$, with the vehicle state being described by 
\begin{equation}
	\vehiclestate = 
	\begin{bmatrix}
		\pbo & \pbp & \pbpp
