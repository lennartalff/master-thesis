...
\end{table}
The evaluation in terms of reaching the high level goal of passing a hoop is depicted in \Cref{fig:hoop-experiment}.
\begin{figure}
	\centering
	\subfloat[Trajectory tracking without implicit feedback.\label{fig:hoop-experiment-without-replanning}]{
		\centering
		\input{plots/lab/explicit/ring.tex}
        
	}
	\subfloat[Mixed implicit feedback and tracking controller.\label{fig:hoop-experiment-with-replanning}]{
		\centering
